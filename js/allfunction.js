...
// colorout轮播时其余圆点的颜色
// colorover轮播时当前圆点的颜色
function Seamless(win,li,img,btnR,btnL,t,colorout,colorover){
...
function moveL(){
  ...
  animate(img[index],{left:imgW},function(){flag=true})
  animate(img[num],{left:0})
  for(var i=0;i<img.length;i++){
   li[i].style.background=colorout
}
